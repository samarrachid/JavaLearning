...
public class numberArray {
	public static void main(String[] args) {
		...
		// numberArray[i] = i;
		// System.out.println("test" + Arrays.toString(numberArray));
		// }
		...
		System.out.println();
		// here why are we assigning j as new value while we've already assigned
		// i?n
		for (int j = 0; j < numberArray.length; j++) {
			System.out.print("| " + j + " ");
		}
		// if i don't write the below statement the the row won't be printed,
		// why?!
		...
		System.out.println("\n");
		// start at a specific place and end at a specific one, start at index 3
		// end at index 6
